...
export function Stats() {
  return (
    <section className="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-[#130E26] border border-[#261E45] rounded-3xl p-8 sm:p-10 text-white shadow-2xl relative overflow-hidden">
        {/* Ambient Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#3897F0]/5 via-transparent to-[#3897F0]/5 pointer-events-none" />
          ...
          {statsData.map((stat, index) => (
            <div
              ...
              className={`flex flex-col items-center justify-center p-4 transition-transform duration-300 hover:scale-105 ${
                index !== statsData.length - 1 ? 'md:border-r md:border-[#261E45]' : ''
              }`}
            >
