        ...
        <div className="bg-gradient-to-r from-[#130E26] via-[#1C1635] to-[#130E26] border-b border-[#261E45] text-white py-14 px-4 sm:px-6 lg:px-8 mb-12 shadow-lg text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white mb-3">
              TAILORED PRINTING <span className="text-[#3897F0]">SOLUTIONS</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {solutionsList.map((item) => {
              ...
              return (
                ...
                >
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-blue-50 text-[#3897F0] flex items-center justify-center mb-6 group-hover:bg-[#3897F0] group-hover:text-white transition-colors duration-300">
                      <Icon className="w-7 h-7" />
                    </div>
                    <h3 className="text-lg font-extrabold text-slate-900 mb-3 group-hover:text-[#3897F0] transition-colors">
                      {item.title}
                    </h3>
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center gap-2 text-xs font-bold text-[#3897F0]">
                    <CheckCircle2 className="w-4 h-4 text-[#3897F0]" />
