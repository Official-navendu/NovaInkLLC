...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-['Manrope',sans-serif] flex flex-col justify-between">
      ...
      <main className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-md mx-auto w-full flex-1 flex flex-col justify-center">
        <div className="bg-white border border-slate-200/90 rounded-3xl p-8 shadow-xl shadow-slate-200/50">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 uppercase tracking-tight">
              SIGN IN TO <span className="text-[#0096D6]">NOVA INK</span>
            </h1>
            <p className="text-xs text-slate-500 font-medium mt-1">
              Access your order history, tracked shipments, and saved supplies.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <a
                href="#forgot"
                onClick={(e) => { e.preventDefault(); alert('Password reset link sent to your email! (Demo)') }}
