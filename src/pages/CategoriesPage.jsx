...
import { ArrowRight, CheckCircle, Tag, Truck, Headphones, ShieldCheck } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 flex flex-col font-['Manrope',sans-serif] selection:bg-[#0096D6] selection:text-white">
      ...
      <main className="flex-grow pt-24">
        ...
        {/* New Informational Section 1: Need Help Choosing? */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-white border border-slate-200/80 rounded-3xl p-8 sm:p-12 lg:p-14 text-slate-900 shadow-xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="relative w-full max-w-md bg-slate-50 border border-slate-200/80 rounded-2xl p-6 shadow-md flex items-center justify-center">
                  <img
        ...
        {/* New Informational Section 2: Everything You Need for Everyday Printing */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-gradient-to-br from-white via-slate-50/40 to-blue-50/20 border border-slate-200/90 rounded-3xl p-8 sm:p-12 lg:p-14 text-slate-900 shadow-xl relative overflow-hidden">
            {/* Ambient Accent */}
