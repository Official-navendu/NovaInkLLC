        ...
        <div className="bg-gradient-to-r from-[#130E26] via-[#1C1635] to-[#130E26] border-b border-[#261E45] text-white py-14 px-4 sm:px-6 lg:px-8 mb-12 shadow-lg text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white mb-3">
              EXPLORE OUR <span className="text-[#3897F0]">CATEGORIES</span>
            </h1>
            ...
            {categoriesData.map((cat) => (
              ...
              >
                <div className="p-6">
                  ...
                  <h3 className="text-lg font-extrabold text-slate-900 group-hover:text-[#3897F0] transition-colors mb-2">
                    {cat.title}
                  </h3>
                ...
                <div className="px-6 pb-6">
                  <Link
                    to="/shop"
                    className="inline-flex items-center gap-2 text-xs font-bold text-[#3897F0] group-hover:underline"
                  >
