        ...
        <div className="bg-gradient-to-r from-[#130E26] via-[#1C1635] to-[#130E26] border-b border-[#261E45] text-white py-14 px-4 sm:px-6 lg:px-8 mb-12 shadow-lg text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white mb-3">
              REDEFINING PRINTING <span className="text-[#3897F0]">EXCELLENCE</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/80 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4">
              <span className="text-xs font-extrabold text-[#3897F0] uppercase tracking-wider">OUR MISSION</span>
            ...
            {values.map((v) => {
              ...
              return (
                <div key={v.title} className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs text-center">
                  <div className="w-12 h-12 rounded-xl bg-blue-50 text-[#3897F0] flex items-center justify-center mx-auto mb-4">
